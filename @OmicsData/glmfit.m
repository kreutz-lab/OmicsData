...
% 
%   GLMFIT Fit a generalized linear model and uses isnan(O) as data. If
%   there are no NaN, then iszero is analyzed instead.
% 
...
%   X       Design matrix
% 
%   stats.p       p-values (indicating significance of having different means)
% 
...
% function [bb,dev,stats] = glmfit_core(x,y,distr,varargin)

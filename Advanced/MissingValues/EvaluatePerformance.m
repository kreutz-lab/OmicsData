% [O,algo] = EvaluatePerformance(O,[rankby,RMSEttest,group])
%
...
function [O,algo] = EvaluatePerformance(O,rankby,RMSEttest,group)

if ~exist('O','var')
    error('OmicsData object has to be passed in to function GetPerformance.m.')
end
